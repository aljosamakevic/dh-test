...
import { FileInfo, HttpClientConfig, StorageHubClient, initWasm } from '@storagehub-sdk/core';
...
async function run() {
  ...
  const siweSession = await mspClient.auth.SIWE(walletClient, domainSeparator, uri);
