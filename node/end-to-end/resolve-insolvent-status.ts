...
import { calculateTimeRemaining, getBalance } from './operations/costOperations.js';
// --8<-- [end:imports]
...
async function run() {
  ...
  // 2. Select `paymentStreams.payOutstandingDebt(providers)`
  // 3. Providers can be found here: https://datahaven.app/testnet/payments
  // 6. Select paymentStreams.clearInsolventFlag()
