...
import { FileManager, HttpClientConfig, ReplicationLevel, StorageHubClient, initWasm } from '@storagehub-sdk/core';
...
async function run() {
  ...
  // const sessionProvider = async () => undefined; // No authentication for this demo  //** */
  ...
  // Example: 0xdd2148ff63c15826ab42953a9d214770e6c2a73b22b83d28819a1777ab9d1322   //** */
